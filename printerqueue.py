...
class Queue():
    ...
    def swap_head(self, new_head):
        """Swaps out the first item of the queue"""
...
movies = ["Toy Story", "Bug's Life", "Finding Nemo", "Wall-E"]

my_movie_queue = add_jobs(movies)

print(my_movie_queue)

my_movie_queue.swap_head("Up")
